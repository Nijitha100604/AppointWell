...
const RelatedDoctors = ({docId, speciality}) => {
    ...
    }, [doctors, docId, speciality, setRelDocs])
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-10 text-gray-900 md:mx-10">
        ...
        className="bg-blue-300 text-gray-600 px-12 py-3 rounded-full mt-10 cursor-pointer hover:translate-y-[-10px] transition-all duration-500">More</button>
    </div>
  )
}
