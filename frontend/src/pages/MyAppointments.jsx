          ...
          doctors.slice(0,3).map((item, index)=>(
            ...
            key={index}>
              ...
              <div className="flex flex-col gap-2 justify-end">
                <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-indigo-400 hover:text-white transition-all duration:500">Pay Online</button>
