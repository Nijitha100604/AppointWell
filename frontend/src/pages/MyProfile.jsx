    ...
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      
      {
        ...
        ? <label htmlFor="image">
            <div className="inline-block relative cursor-pointer">
              ...
              src={image ? URL.createObjectURL(image) : userData.image} alt="user-image" />
        ...
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
          ...
          <p className="font-medium">Address:</p>
          {
            ...
            ? <p>
              ...
              type="text" value={userData.address.line1} onChange={(e) => setUserData(prev => ({...prev, address: {...prev.address, line1: e.target.value}}))}/>
              <br />
              <input className="bg-gray-200"
              type="text" value={userData.address.line2} onChange={(e) => setUserData(prev => ({...prev, address: {...prev.address, line2: e.target.value}}))}/>
            </p>
      ...
      <div>
        ...
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
          ...
          {
            isEdit 
            ? <input className="max-w-28 bg-gray-200"
      ...
      <div className="mt-10">
        {
          isEdit
          ? <button className="border border-indigo-400 px-8 py-2 rounded-full hover:bg-indigo-400 hover:text-white transition-all duration 500" onClick={updateUserProfileData}>Save Information</button>
          : <button className="border border-indigo-400 px-8 py-2 rounded-full hover:bg-indigo-400 hover:text-white transition-all duration 500" onClick={()=>setIsEdit(true)}>Edit</button>
        }
      </div>
    </div>
  )
